!(function() {
  ...
  function a(t) {
    return (
      !(t.type && !w[t.type.trim()]) &&
      ((!x || !t.hasAttribute("nomodule")) && !(!x && "module" === t.type))
    );
  }
  function c(t, e) {
    return function(n) {
    ...
    _ = (function() {
      ...
      return (
        ...
        (t.prototype.insertContentInHead = function() {
          ...
          if (
            (this.scriptStack.harvestScriptsAfterDocWrite(i),
            n(i.head.childNodes, this.insertionPointMarker),
            i.body.childNodes.length)
          ) {
            for (
              var o = Array.prototype.slice.call(i.body.childNodes),
                a = this.insertionPointMarker.nextSibling;
              a;

            )
              o.push(a), (a = a.nextSibling);
        ...
        (t.prototype.write = function(t, e) {
          ...
          n && o(n) && n.hasAttribute("async")
            ? (r = e ? k : P).call.apply(r, [document].concat(t))
